...
# Bug 2: Approve checkbox not working - Fixed
...
# Bug 4: Clicking on View More button not showing correct data - Fixed
...
# Bug 5: Employees filter not available during loading more data - Fixed - App.tsx - L33
...
# Bug 6: View more button not working as expected -- Fixed -- App.tsx - L88
...
# Bug 7: Approving a transaction won't persist the new value - Fixed - App.tsx
